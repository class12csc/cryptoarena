...
def inserting_vals():
    ...
    mycur.execute(
        "INSERT INTO USERS VALUES('1234567890','Chase','1234','Admin','admin','admin','123456789012','1200');")
...
def introductory_display():
    print("\n\n\n")
    print("**********************************************************************************************")
    print("""  _______ _             ______ _                                ____            _             
 |__   __| |           |  ____(_)                              |  _ \          | |            
    | |  | |__   ___   | |__   _ _ __   __ _ _ __   ___ ___    | |_) |_ __ ___ | | _____ _ __ 
    | |  | '_ \ / _ \  |  __| | | '_ \ / _` | '_ \ / __/ _ \   |  _ <| '__/ _ \| |/ / _ \ '__|
    | |  | | | |  __/  | |    | | | | | (_| | | | | (_|  __/   | |_) | | | (_) |   <  __/ |   
    |_|  |_| |_|\___|  |_|    |_|_| |_|\__,_|_| |_|\___\___|   |____/|_|  \___/|_|\_\___|_|   
    ...
    while True:
        ...
        if selec == '1':
            ...
            while pin_entered != pinno[0]:
                ...
                print(f"Your current balance is: ${str(round(net_balance,2))}")
            mycon.commit()
            ...
            while replycu.isalpha() == False or replycu.lower() not in ['y', 'n']:
                ...
                if replycu.lower() == "y":
                    ...
                    print(
                        f"{user_del.capitalize()} account has been deleted successfully.")
                    mycon.commit()
                    print()
                else:
                    print()
            ...
            while stock_to_be_bought.lower() not in temp_list:
                ...
                while pin_entered != pinno[0]:
                    ...
                    if net_balance < 0:
                        ...
                        print()
                        print(
                            f"You've successfully bought {stock_to_be_bought} for a price of ${str(round(float(quantity) * float(stock_value[0][0]),2))}.")
                        print(
...
def sign_up():
    ...
    # Aadhar number
    aadhar = input("Please enter your 12 digit Aadhar number:")

    while aadhar.isnumeric() == False or len(aadhar) != 12:
